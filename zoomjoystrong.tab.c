...
static const char *const yytname[] =
{
  ...
  "SET_COLOR", "END", "INT", "END_STATEMENT", "FLOAT", "$accept", "line", YY_NULLPTR
};
#endif
...
#line 34 "zoomjoystrong.y" /* yacc.c:1646  */
    { printf(" %s %d %d %d %d%s", (yyvsp[-5].str), (yyvsp[-4].i), (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i)); line((yyvsp[-4].i), (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i)); }
#line 1212 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;


#line 1216 "zoomjoystrong.tab.c" /* yacc.c:1646  */
      default: break;
    }
